  ...
  return (
    <div className="mx-auto max-w-md space-y-4">
      <div className="text-center">
        ...
        <p className="text-sm text-slate-300 mt-1">Увійди, щоб додавати відгуки, оформлювати квитки та керувати замовленнями.</p>
      </div>
      ...
      <Card>
        <div className="p-5 space-y-3">
          ...
          <div className="flex items-center justify-between text-sm">
            <Link href={`/register?next=${encodeURIComponent(next)}`} className="text-slate-200 hover:text-white underline underline-offset-4">
              Створити акаунт
            </Link>
